...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="iOSDropDown",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface JRDropDown (SWIFT_EXTENSION(iOSDropDown)) <UITableViewDelegate>
- (void)tableView:(UITableView * _Nonnull)tableView didSelectRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath;
@end

@class UITableViewCell;

@interface JRDropDown (SWIFT_EXTENSION(iOSDropDown)) <UITableViewDataSource>
...
@interface JRDropDown (SWIFT_EXTENSION(iOSDropDown)) <UITextFieldDelegate>
