...
- (void)loadingStarted;
- (void)checkRestrictedMesssaging;
- (BOOL)checkRestriceted SWIFT_WARN_UNUSED_RESULT;
- (double)twentyFourHoursAgoTimeStamp SWIFT_WARN_UNUSED_RESULT;
- (void)loadingFinishedWithError:(NSError * _Nullable)_;
- (void)newFormMessageAdded;
...
SWIFT_CLASS("_TtC25KommunicateChatUI_iOS_SDK19KMAudioRecordButton")
@interface KMAudioRecordButton : UIButton
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)_ OBJC_DESIGNATED_INITIALIZER SWIFT_UNAVAILABLE;
@property (nonatomic, readonly) CGSize intrinsicContentSize;
@end
...
@interface KMAudioRecordButton (SWIFT_EXTENSION(KommunicateChatUI_iOS_SDK)) <AVAudioRecorderDelegate>
...
SWIFT_CLASS("_TtC25KommunicateChatUI_iOS_SDK21KMAutoCompleteManager")
@interface KMAutoCompleteManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


@interface KMAutoCompleteManager (SWIFT_EXTENSION(KommunicateChatUI_iOS_SDK)) <UITextViewDelegate>
...
@interface KMAutoCompleteManager (SWIFT_EXTENSION(KommunicateChatUI_iOS_SDK)) <UITableViewDataSource, UITableViewDelegate>
- (NSInteger)numberOfSectionsInTableView:(UITableView * _Nonnull)_ SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC25KommunicateChatUI_iOS_SDK17KMCustomSearchBar")
@interface KMCustomSearchBar : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)_ SWIFT_UNAVAILABLE;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC25KommunicateChatUI_iOS_SDK25KMExtendedTouchAreaButton")
@interface KMExtendedTouchAreaButton : UIButton
...
SWIFT_CLASS("_TtC25KommunicateChatUI_iOS_SDK14KMLanguageView")
@interface KMLanguageView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)_ SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC25KommunicateChatUI_iOS_SDK13KMMessageView")
@interface KMMessageView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)_ SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
